    ...
    try:
        ...
        if is_high_risk_wallet_action(fraud):
            ...
            try:
                ...
                enqueue_job("wallet_risk_scan", {"profile_id": sender_profile_id, "fraud": fraud}, priority=2, queue="wallet")
            except Exception:
                pass
...
def subscribe_to_creator(subscriber_profile_id, creator_profile_id, tier_name="basic", price_cents=0):
    ...
    try:
        ...
        if is_high_risk_wallet_action(fraud):
            ...
            try:
                from services.job_queue_service import enqueue_job
                enqueue_job("wallet_risk_scan", {"profile_id": subscriber_profile_id, "fraud": fraud}, priority=2, queue="wallet")
            except Exception:
                pass
            return {"ok": False, "error": "high_risk_wallet_action", "fraud": fraud}
    except Exception:
