...
from .models import DatingLike, DatingPass, DatingPhoto, DatingPreference, DatingProfile, Match
...
class DatingProfileAdmin(admin.ModelAdmin):
    list_display = ("display_name", "user", "gender", "city", "region", "relationship_goal", "is_visible", "is_verified_dating", "created_at")
    search_fields = ("display_name", "user__username", "bio", "city", "region", "occupation")
    list_filter = ("gender", "relationship_goal", "is_visible", "is_verified_dating", "city", "region")
