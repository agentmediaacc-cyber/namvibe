...
AVATAR_UPLOAD_MAX_BYTES = env_int("AVATAR_UPLOAD_MAX_BYTES", 5 * 1024 * 1024)
COVER_UPLOAD_MAX_BYTES = env_int("COVER_UPLOAD_MAX_BYTES", 8 * 1024 * 1024)
STORY_MEDIA_MAX_BYTES = env_int("STORY_MEDIA_MAX_BYTES", 20 * 1024 * 1024)
POST_VIDEO_MAX_BYTES = env_int("POST_VIDEO_MAX_BYTES", 80 * 1024 * 1024)
AUDIO_UPLOAD_MAX_BYTES = env_int("AUDIO_UPLOAD_MAX_BYTES", 40 * 1024 * 1024)
UPLOAD_LIMIT_BUFFER_BYTES = env_int("UPLOAD_LIMIT_BUFFER_BYTES", 4 * 1024 * 1024)
DEFAULT_UPLOAD_GATE_BYTES = max(
    AVATAR_UPLOAD_MAX_BYTES,
    COVER_UPLOAD_MAX_BYTES,
    STORY_MEDIA_MAX_BYTES,
    POST_VIDEO_MAX_BYTES,
    AUDIO_UPLOAD_MAX_BYTES,
) + UPLOAD_LIMIT_BUFFER_BYTES
DATA_UPLOAD_MAX_MEMORY_SIZE = env_int("DATA_UPLOAD_MAX_MEMORY_SIZE", DEFAULT_UPLOAD_GATE_BYTES)
FILE_UPLOAD_MAX_MEMORY_SIZE = env_int("FILE_UPLOAD_MAX_MEMORY_SIZE", DEFAULT_UPLOAD_GATE_BYTES)
