...
_MESSAGE_COLUMNS = "id, thread_id, sender_profile_id, body, message_type, media_url, delivery_status, is_seen, seen_at, read_at, delivered_at, created_at, edited_at, deleted_at, deleted_for_everyone, reply_to_message_id, parent_message_id, is_forwarded, client_event_id, voice_duration_seconds"
