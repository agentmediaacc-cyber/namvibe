...
def setup():
    ...
    for pid, uname, email in [
        ...
        for t in ["chain_call_participants", "chain_thread_members", "chain_online_presence", "chain_message_reactions", "chain_message_edits", "chain_blocks", "chain_call_logs", "chain_call_events"]:
