...
ok("keyboard support") if "visualViewport" in js or "visual-viewport" in js or "keyboard" in js.lower() else warn("keyboard support")
...
ok("scroll-to-bottom") if "nv-scroll-bottom" in css_msg or "scroll-to-bottom" in css_chat or "wireScrollToBottom" in js or "scrollToBottom" in js or "scrollToMessage" in js else warn("scroll-to-bottom button")
