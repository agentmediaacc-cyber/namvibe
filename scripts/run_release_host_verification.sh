...
run_stage() {
  ...
  case "$stage" in
    database_path_selection|neon_dns|neon_tcp|neon_connection|call_security_integration|cloudflare_process|cloudflare_connection|public_dns|public_tls|public_routes|socketio_handshake|browser_desktop|browser_mobile|runtime_log_scan|log_secret_scan)
